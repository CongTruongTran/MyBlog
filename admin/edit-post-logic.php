...
// make sure edit post button clicked
if(isset($_POST['submit'])) {
    ...
    //     $_SESSION['edit-post'] = "Couldn't update post. Invalid form data on edit post page!!";
        ...
        // delate existing thumbnail of new thumbnail is available
        if($thumbnail['name']) {
        ...
        if(in_array($extension, $allowed_files)){
            // make sure avatar is not too big (2mb+)
    ...
    // redirect back (with form data) to edit-post page if there is nay problem
    if($_SESSION['edit-post']){
        ...
        // set thumbnail name if a one was uploaded, else keep old thumbnail name
